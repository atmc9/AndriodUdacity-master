...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (8) Create a method called setPreferenceSummary that accepts a Preference and an Object and sets the summary of the pref_general

        // TODO (5) Override onCreatePreferences and add the pref_general xml file using addPreferencesFromResource

        // Do step 9 within onCreatePreference
        // TODO (9) Set the pref_general summary on each pref_general that isn't a CheckBoxPreference
